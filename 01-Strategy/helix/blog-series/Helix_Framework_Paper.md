...
## The Helix Framework (brief)

The Helix Framework is one way to meet these desiderata. A full elaboration is beyond the scope of this paper; we summarize here and refer readers to the operational draft at cytognosis.org/helix.

Briefly: the Framework pairs a 501(c)(3) nonprofit parent (mission-locked, IP-owning, non-dilutively funded in Phase I) with one or more Public Benefit Corporation subsidiaries (commercial, VC-compatible, license-receiving). Between them sit two novel capital mechanisms (promise of future equity for Phase I contributors; people-as-seed-funders revenue reinvestment). Above them sits a triple-layer accountability structure (structural bylaws constraints; community advisory boards with governance powers; external independent review). Running through all of this is an explicit three-phase, fifteen-year lifecycle with quantitative, bylaw-codified gates at each transition.

The Cytognosis Foundation is the first implementation of the Framework and the case study against which it is being tested. Detailed operational documents (bylaws, 15-year strategic roadmap, Phase 1 operational plan) are being published alongside this commentary as open artifacts under CC BY 4.0.

## Open questions for the community

We publish this draft as an open commentary because the questions it raises cannot be answered by any single organization. Five questions in particular would benefit from multi-organization input:
