...
```mermaid
gantt
    title Cytognosis Funding Pipeline: May-October 2026
    dateFormat YYYY-MM-DD
    section Immediate (Week 1)
    EA Infrastructure Fund Application :active, 2026-05-24, 7d
    Emergent Ventures Pitch :active, 2026-05-24, 7d
    Lambda Labs Research Grant :active, 2026-05-24, 7d
    Manifund Applications :active, 2026-05-24, 14d
    section Near-Term (Weeks 2-6)
    AWS Imagine Decision :2026-06-15, 2026-07-15
    ARPA-H PHO Solution Summary :2026-05-27, 2026-06-15
    EA Fund Decision :2026-06-15, 2026-07-30
    PCORI LOI Preparation :2026-06-01, 2026-07-15
    section July Deadlines
    SFF HSEE Application :2026-06-15, 2026-07-08
    ARPA-H PHO Full Proposal :crit, 2026-07-01, 2026-08-15
    section August-October
    AWS Imagine Funding :milestone, 2026-08-15, 0d
    ARPA-H PHO Decision :milestone, 2026-09-15, 0d
    PCORI Full Application :2026-08-15, 2026-09-01
    NSF Smart Health Prep :2026-08-01, 2026-10-01
    Target $1M Milestone :crit, milestone, 2026-10-01, 0d
```
...
```mermaid
flowchart TD
    A[Week 1: May 24-31] --> B{Apply to Fast-Track Opportunities}
    B --> C[EA Infrastructure Fund<br/>Online application]
    B --> D[Emergent Ventures<br/>Email pitch to Tyler Cowen]
    B --> E[Lambda Research Grant<br/>Online form]
    B --> F[Manifund<br/>Create profile + submit]
    
    A --> G{Verify Critical Deadlines}
    G --> H[AWS Imagine Grant<br/>Confirm application status]
    G --> I[ARPA-H DELPHI<br/>Check if late submission possible]
    
    A --> J{Begin Major Applications}
    J --> K[ARPA-H PHO Solution Summary<br/>Target submit by June 1]
    J --> L[SFF HSEE Application<br/>Due July 8]
    
    K --> M{PHO Feedback}
    M -->|Encouraged| N[Full Proposal<br/>2-3 months]
    M -->|Discouraged| O[Pivot to HSF ISO<br/>or other ARPA-H offices]
    
    N --> P[Contract Negotiation<br/>4-6 months]
    P --> Q[Funding Q1 2027]
    
    L --> R[SFF Decision Nov 2026]
    R --> S[Funding March 2027]
    
    C --> T{EA Decision<br/>July-August}
    T -->|Approved| U[Funding Aug-Sept 2026]
    
    D --> V{EV Decision<br/>Days-Weeks}
    V -->|Approved| W[Funding June-July 2026]
    
    H --> X{AWS Decision<br/>July}
    X -->|Approved| Y[Funding Aug-Sept 2026]
