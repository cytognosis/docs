...
Repos: docs = `https://github.com/cytognosis/docs` (authoring source for slot-library data); code = `https://github.com/cytognosis/cytos` (`src/cytos/scholarly/funding/`, engine + schema mirror).
