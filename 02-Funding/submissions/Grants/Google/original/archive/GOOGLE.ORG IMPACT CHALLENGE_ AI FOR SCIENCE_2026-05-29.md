...
First-line psychiatric treatments fail for 47%-58% of patients, with relapse rates ranging from 40%-71%. Suboptimal therapy results in an annual cost of $528 billion within a $5.3 trillion healthcare system. Although data-driven biotypes show early promise for predicting treatment response, they are limited to single diseases and modalities and lack consistency across cohorts, hindering clinical adoption. Neuroverse, our unified, multimodal map of brain-circuit variation, addresses these limitations, enabling actionable precision psychiatry across diagnostic categories.
...
Our Co-Lead at Human Technopole bridges molecular and circuit neuroscience. Our Senior Advisor at Purdue leads the Institute for Physical AI, contributing expertise in foundation models and scalable computing. The team spans computational neuroscience, AI systems, and open-source infrastructure.
...
**AI / ML Engineer (hire, 100%):** geometric deep learning, foundation model development.
...
**Description and Details (100 words):** Salaries benchmarked vs. 2026 Bay-area Pave / levels.fyi / BLS OEWS 15-2051 / 19-1042, nonprofit-adjusted; 30% fringe (HHS). AI / ML Engineer 100% × 36m, $565K ($145K base). Clinical Data Scientist (intern) 100% × 36m, $293K ($75K base). Computational Neuroscientist (intern) 100% × 30m from M6, $228K ($70K base). Multimodal Integration Scientist 50% × 18m from M18, $127K ($130K base). Open-Source / Edge AI Engineer 50% × 24m from M12, $150K ($115K base). Project Manager 50% × 36m, $215K ($110K base). Purdue subaward (Grama, Physical AI / HPC) 8% × 36m, $140K. PI (50%) and the AlphaGenome-based genotype FM are externally funded.
