...
| **Skills** | `.agents/steering/` + cytoskills repo | Agent symlinks (Claude, Gemini, Kiro) |
...
| wiki-js | ghcr.io/requarks/wiki:2 | 512 MB |
| grobid | grobid/grobid:0.8.1 | 4 GB |
| cytognosis-compute | cyto-compute:0.6.0 | 2 GB |
| cytognosis-gpu | cyto-gpu:0.6.0 | 16 GB |

**14 service definitions**: caddy, calcom, excalidraw, wiki-js, jupyter, logseq, mermaid, mlflow, neo4j, seek, solr, surrealdb, zoekt, zotero

**4 stacks**:

| Stack | Target | Services |
|-------|--------|----------|
| **core** | e2-highmem-2 (x86) | caddy, calcom, excalidraw, mermaid, logseq, mlflow |
...
**CLI**: `cytoinfra container {list,add,build,push,pull}`, `cytoinfra service {deploy,status,stop}`, `cytoinfra wiki-js setup`
...
| P0-6 | Create `cytognosis/docs` GitHub repo | ✅ DONE | github |
