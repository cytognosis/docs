...
| Domain semantic-quality evaluation | [evaluation harness](../domain_semantic_quality/README.md), [rubric](../domain_semantic_quality/reviewer_rubric.md), [config placeholder](../../config/domain_semantic_quality.example.yaml) | Confirm semantic-quality evidence is separated from structural conformance and synthetic scores are not represented as expert validation. |
| Regulated-profile review | [regulated-profile packet](../regulated_profile_review/README.md), [checklist](../regulated_profile_review/reviewer_checklist.md), [config placeholder](../../config/regulated_profile_review.example.yaml) | Confirm CAP-Med profile review remains external and the packet does not claim regulatory clearance or clinical approval. |
