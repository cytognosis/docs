...
| File | Lines | Content |
|---|---|---|
| [README.md](README.md) | 59 | Index of sensor docs, TL;DR recommended stack |
...
| [sensor-architecture.md](../../../03-Products/Cytonome/Yar/sensor-architecture.md) | 379 | Pluggable sensor framework (Pydantic Protocol, SensorDescriptor, Voice Emotion Sensor 0 reference implementation) |
...
| universal-sensor-schema-vault.md (target archived/removed) | 1,458 | Comprehensive vault copy with full schema details |
...
| linkml_kg_playbook/07_sosa_ssn_to_linkml.md (target archived/removed) | 217 | SOSA/SSN → LinkML conversion walkthrough (CytoSensor, CytoObservation) |
| sssom_tooling_for_cytognosis.md (target archived/removed) | 505 | SSSOM cross-ontology mapping for the scholarly KG |
| [data.md](../../../05-Research/neuroverse/schema-survey/data.md) | 254 | Data storage research |
| [linkml_kg_playbook/02_schema_landscape.md](../../infrastructure/data-strategy/linkml-kg-playbook/02_schema_landscape.md) | 145 | Schema landscape survey |
