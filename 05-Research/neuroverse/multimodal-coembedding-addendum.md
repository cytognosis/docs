...
> **Canonical home:** `05-Research/neuroverse/multimodal-coembedding-addendum.md` · **Consolidated from:** `Science and Platform/multimodal_coembedding_addendum_deep_dives.md`.
