...
> **Canonical home:** `05-Research/neuroverse/neurobehavioral-phenotype-feature-space.md` · **Consolidated from:** `Science and Platform/cdisc-qrs-feature-space-design.md`.
> **Science foundation:** psychiatric phenotype harmonization; feeds [../../03-Products/Cytoverse/](../../03-Products/Cytoverse/). **Companions:** [cdisc-qrs-instrument-reference.md](cdisc-qrs-instrument-reference.md), [multimodal-coembedding-methods-review.md](multimodal-coembedding-methods-review.md).
