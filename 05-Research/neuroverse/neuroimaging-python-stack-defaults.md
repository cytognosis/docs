> **Status:** Active · **Date:** 2026-05-11 (authored), 2026-07-01 (canonicalized) · **Author:** Cytognosis Foundation
> **Canonical home:** `05-Research/neuroverse/neuroimaging-python-stack-defaults.md` · **Consolidated from:** `Science and Platform/cytognosis_python_defaults_neuroimaging_2026.md`.
> **Note:** implementation-layer defaults; cross-references `04-Engineering/standards` (dev-standards) and the co-embedding review.
