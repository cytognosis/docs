...
Yar is a **personalized cognitive substrate** for neurodivergent people. Not a note app. Not a productivity tool. Not an AI therapist. Yar is the companion that sits beside you and reduces the invisible tax of existing in systems that were not designed for your cognition.
...
Yar is built by neurodivergent people, for neurodivergent people. It runs on your phone, your laptop, and your browser. Your data never leaves your devices.
...
> [!IMPORTANT]
> **The browser extension may be the most important interface.** Neurodivergent people spend enormous time in browsers (reading, researching, communicating). Contextual capture where cognition already happens is more valuable than requiring a separate app switch.
...
**Target README**: 3-5 KB document that speaks to neurodivergent users first, developers second.
...
Built by neurodivergent people. Runs on your devices. Your data stays yours.
